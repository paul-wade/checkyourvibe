...
function usage(): string {
  return [
    ...
    '  --self                       Run the work on the orchestrating lane, as a sub-agent of',
    '                               this session. Nothing is spawned: the record is opened, the',
    '                               before-snapshot taken, and the prompt printed for you to do.',
    '',
    'Finishing a record:',
    '  --close <id>                 Close a dispatch opened with --self, judging it by what',
    '                               changed against its before-snapshot.',
    '  --abandon <id>               Close an open record whose executor is gone, as',
    '                               did-not-complete. Until a record is closed it counts against',
    '                               its lane cap and reserves the paths it declared, so a session',
    '                               that stopped without closing blocks the next dispatch.',
    '  --reason <text>              Why it was abandoned. Recorded with --abandon.',
    '',
    'Output:',
